...
--
-- Network: Small fictional 11kV distribution network, Birmingham area, WGS84.
--
--   PSS-001 (Primary 33kV Substation)
--   ├── OHL-001 ──── SW-001 ──── SSA-001 (Secondary 11kV, north-east)
--   └── OHL-002 ──── SW-002 ──── SSB-001 (Secondary 11kV, south-west)
--
...
-- Switch 1 (SW-001) — between PSS and SSA
INSERT INTO network_model.object
    (uuid, namespace, identity, class_uuid, discriminator, geo_geometry, attributes, hash)
VALUES (
...
-- Switch 2 (SW-002) — between PSS and SSB
INSERT INTO network_model.object
    (uuid, namespace, identity, class_uuid, discriminator, geo_geometry, attributes, hash)
VALUES (
...
-- Overhead Line A (OHL-001) — PSS → SW-001 → SSA
INSERT INTO network_model.object
    (uuid, namespace, identity, class_uuid, discriminator, geo_geometry, attributes, hash)
VALUES (
...
-- Overhead Line B (OHL-002) — PSS → SW-002 → SSB
INSERT INTO network_model.object
    (uuid, namespace, identity, class_uuid, discriminator, geo_geometry, attributes, hash)
VALUES (
